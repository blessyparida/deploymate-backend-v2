...
export async function commitAndPR({
  ...
  try {
    ...
    // 4️⃣ Create new commit
    const newCommitMessage = `🔧 DeployMate Auto Commit: ${Object.keys(generatedFiles).join(", ")}`;
    ...
    // 5️⃣ Create a new branch for PR
    ...
    console.error("❌ Error creating commit/PR:", err.message);
